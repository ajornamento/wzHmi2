...
class PipeWidget extends BaseWidget {
  constructor() {
    super(...arguments);
    __publicField(this, "_gradStop0", null);
    __publicField(this, "_gradStop1", null);
    __publicField(this, "_gradStop2", null);
    __publicField(this, "_gradStop3", null);
    __publicField(this, "_gradStop4", null);
    __publicField(this, "_flowPath", null);
    __publicField(this, "_flowInterval", null);
    __publicField(this, "_flowOffset", 0);
  }
  render() {
    this.innerHTML = "";
...
function makeStop(ns, offset, color) {
  const stop = document.createElementNS(ns, "stop");
  stop.setAttribute("offset", offset);
  stop.setAttribute("stop-color", color);
  return stop;
}
function addFlange(svg, ns, x, y, w, h, color) {
