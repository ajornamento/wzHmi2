...
class BaseWidget extends HTMLElement {
  constructor() {
    ...
    __publicField(this, "_extraValues", /* @__PURE__ */ new Map());
    __publicField(this, "_blinkInterval", null);
    __publicField(this, "_blinkState", false);
    __publicField(this, "_blinkColor", null);
    __publicField(this, "_blinkStopToken", 0);
    __publicField(this, "_pulseInterval", null);
    __publicField(this, "_pulseScale", 1);
    __publicField(this, "_labelElement", null);
    __publicField(this, "_valueElement", null);
