...
class ReactorWidget extends BaseWidget {
  constructor() {
    super(...arguments);
    __publicField(this, "_agitator", null);
    __publicField(this, "_agitInterval", null);
    __publicField(this, "_agitAngle", 0);
    __publicField(this, "_cx", 0);
    __publicField(this, "_cy", 0);
  }
  render() {
    this.innerHTML = "";
  ...
  updateVisuals() {
    ...
    if (active || anim?.effect === "flow") this.startAgitator();
