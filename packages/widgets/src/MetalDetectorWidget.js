...
class MetalDetectorWidget extends BaseWidget {
  constructor() {
    super(...arguments);
    __publicField(this, "_leftLed", null);
    __publicField(this, "_rightLed", null);
    __publicField(this, "_archEls", []);
    __publicField(this, "_glowEl", null);
    __publicField(this, "_countText", null);
  ...
  render() {
    ...
    glow.setAttribute("x", String(bx));
    glow.setAttribute("y", String(by));
    glow.setAttribute("width", String(bw));
    glow.setAttribute("height", String(archH));
    ...
    lp.setAttribute("x", String(bx));
    lp.setAttribute("y", String(by));
    lp.setAttribute("width", String(pillarW));
    lp.setAttribute("height", String(archH));
    lp.setAttribute("rx", "2");
    lp.setAttribute("fill", "#3a3a4a");
    lp.setAttribute("stroke", "#556677");
    lp.setAttribute("stroke-width", "1");
    this._archEls.push(lp);
    svg.appendChild(lp);
    const lph = document.createElementNS(ns, "rect");
    lph.setAttribute("x", String(bx + 2));
    lph.setAttribute("y", String(by + 2));
    lph.setAttribute("width", "3");
    lph.setAttribute("height", String(archH - 4));
    lph.setAttribute("rx", "1");
    lph.setAttribute("fill", "rgba(255,255,255,0.07)");
    svg.appendChild(lph);
    const rp = document.createElementNS(ns, "rect");
    rp.setAttribute("x", String(openX + openW));
    rp.setAttribute("y", String(by));
    rp.setAttribute("width", String(pillarW));
    rp.setAttribute("height", String(archH));
    rp.setAttribute("rx", "2");
    rp.setAttribute("fill", "#3a3a4a");
    rp.setAttribute("stroke", "#556677");
    rp.setAttribute("stroke-width", "1");
    this._archEls.push(rp);
    svg.appendChild(rp);
    const rph = document.createElementNS(ns, "rect");
    rph.setAttribute("x", String(openX + openW + 2));
    rph.setAttribute("y", String(by + 2));
    rph.setAttribute("width", "3");
    rph.setAttribute("height", String(archH - 4));
    rph.setAttribute("rx", "1");
    rph.setAttribute("fill", "rgba(255,255,255,0.07)");
    svg.appendChild(rph);
    const tb = document.createElementNS(ns, "rect");
    tb.setAttribute("x", String(openX));
    tb.setAttribute("y", String(by));
    tb.setAttribute("width", String(openW));
    tb.setAttribute("height", String(barH));
    tb.setAttribute("fill", "#3a3a4a");
    tb.setAttribute("stroke", "#556677");
    tb.setAttribute("stroke-width", "1");
    this._archEls.push(tb);
    svg.appendChild(tb);
    if (openW > 30) {
      ...
      barLbl.textContent = "M\xB7D";
      svg.appendChild(barLbl);
    }
    const opening = document.createElementNS(ns, "rect");
    opening.setAttribute("x", String(openX));
    opening.setAttribute("y", String(openY));
    opening.setAttribute("width", String(openW));
    opening.setAttribute("height", String(openH));
    opening.setAttribute("fill", "#0e0e18");
    svg.appendChild(opening);
    const conv = document.createElementNS(ns, "rect");
    conv.setAttribute("x", String(convX));
    conv.setAttribute("y", String(convY));
    conv.setAttribute("width", String(convW));
    conv.setAttribute("height", String(convH));
    conv.setAttribute("fill", "#252530");
    conv.setAttribute("stroke", "#444");
    ...
    for (let i = 1; i < stripeCount; i++) {
      ...
      stripe.setAttribute("x1", String(sx));
      stripe.setAttribute("y1", String(convY));
      stripe.setAttribute("x2", String(sx));
      stripe.setAttribute("y2", String(convY + convH));
      stripe.setAttribute("stroke", "#333");
      stripe.setAttribute("stroke-width", "0.5");
      svg.appendChild(stripe);
    }
    const convHL = document.createElementNS(ns, "rect");
    convHL.setAttribute("x", String(convX));
    convHL.setAttribute("y", String(convY));
    convHL.setAttribute("width", String(convW));
    convHL.setAttribute("height", "2");
    ...
    leftLed.setAttribute("cy", String(ledCy));
    leftLed.setAttribute("r", String(ledR));
    leftLed.setAttribute("fill", "#222");
    this._leftLed = leftLed;
    ...
    leftLedHL.setAttribute("cy", String(ledCy - 1));
    leftLedHL.setAttribute("r", "1.2");
    ...
    rightLed.setAttribute("cy", String(ledCy));
    rightLed.setAttribute("r", String(ledR));
    rightLed.setAttribute("fill", "#222");
    this._rightLed = rightLed;
    ...
    rightLedHL.setAttribute("cy", String(ledCy - 1));
    rightLedHL.setAttribute("r", "1.2");
    ...
    base.setAttribute("height", String(Math.max(baseH, 10)));
    base.setAttribute("rx", "1");
    base.setAttribute("fill", "#282838");
    base.setAttribute("stroke", "#445566");
    ...
    countText.setAttribute("font-size", String(Math.max(6, Math.round(Math.max(baseH, 10) * 0.6))));
  ...
  updateVisuals() {
    ...
    for (const el of this._archEls) {
      ...
      el.setAttribute("stroke", archStroke);
    }
