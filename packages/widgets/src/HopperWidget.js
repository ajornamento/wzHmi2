...
class HopperWidget extends BaseWidget {
  constructor() {
    super(...arguments);
    __publicField(this, "_fillPoly", null);
    __publicField(this, "_valueText", null);
    __publicField(this, "_topY", 0);
    __publicField(this, "_outletY", 0);
    __publicField(this, "_outletX", 0);
    __publicField(this, "_outletW", 0);
    __publicField(this, "_pad", 0);
  ...
  updateVisuals() {
    if (!this._widget || !this._fillPoly) return;
    this.stopBlink();
    this.stopPulse();
