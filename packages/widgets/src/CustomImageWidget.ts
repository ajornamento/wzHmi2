// 커스텀 이미지 위젯 — base64 이미지를 렌더링하는 범용 커스텀 위젯
import { BaseWidget } from './base/BaseWidget';
import { getCustomWidgetDef } from './customWidgetRegistry';

export class CustomImageWidget extends BaseWidget {
  protected render() {
    this.innerHTML = '';
    ...
    const labelText = this._widget?.properties.label as string | undefined;
    if (labelText) {
