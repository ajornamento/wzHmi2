...
const DEFAULT_FREEFORM = "50,2 96,26 96,74 50,98 4,74 4,26";
...
class TextLabelWidget extends BaseWidget {
  constructor() {
    super(...arguments);
    __publicField(this, "_textEl", null);
    __publicField(this, "_shapeEl", null);
