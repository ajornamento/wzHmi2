...
class TankWidget extends BaseWidget {
  constructor() {
    super(...arguments);
    __publicField(this, "_fill", null);
    __publicField(this, "_valueText", null);
    __publicField(this, "_tankH", 0);
    __publicField(this, "_tankY", 0);
  ...
  updateVisuals() {
    ...
    if (this._labelElement) {
      this._labelElement.textContent = this._widget.properties.label ?? "TANK";
    }
